const LandingPage = () => {
  return (
    <div className="min-h-screen flex flex-col gap-16 custom-container">
      {/* 🌟 HERO SECTION */}
      <section className="hero bg-primary-content py-20 px-6 md:px-20 custom-container rounded-edges min-h-80">
      ...
      {/* 💡 FEATURES SECTION */}
      <section className=" flex items-center justify-center gap-12 flex-col bg-secondary-content py-20 px-6 md:px-20 text-center custom-container rounded-edges min-h-80">
        <h2 className="text-3xl md:text-4xl font-bold mb-10">
          Why Join DevTinder?
        </h2>

        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
          <div className=" text-white card bg-primary shadow-md hover:shadow-xl transition-all duration-300">
      ...
      <section className="bg-primary-content min-h-80 flex flex-col items-center justify-center gap-8 py-20 text-center custom-container rounded-edges">
